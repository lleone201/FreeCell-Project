...
The Deck and Card classes were implemented by Logan. Javier implemented the CardStack class and then we both worked on the FreeCellGUI class together while talking on discord. As you can tell from the amount code, a large majority of the time was speant on the FreeCellGUI class.
